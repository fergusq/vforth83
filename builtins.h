...
enum BuiltinWord {
    ...
    BUILTIN_WORD_BDOS,
    BUILTIN_WORD_INT10H,
    BUILTIN_WORD_LINEMOVE,
    BUILTIN_WORD_UPPER,
    BUILTIN_WORD_DIGIT,
    BUILTIN_WORD_RPICK,
    BUILTIN_WORD_RP_FETCH,
    BUILTIN_WORD_SP_STORE,
    BUILTIN_WORD_RP_STORE,
    BUILTIN_WORD_U_TWO_DIVIDE,
    BUILTIN_WORD_U_GREATER_THAN,
    BUILTIN_WORD_S_TO_D,
    BUILTIN_WORD_COMP,
    BUILTIN_WORD_CAPS_COMP,
    BUILTIN_WORD_LSHIFT,
    BUILTIN_WORD_RSHIFT,
    BUILTIN_WORD_M_TIMES,
    BUILTIN_WORD_M_TIMES_DIVIDE,
    BUILTIN_WORD_FM_DIVIDE_MOD,
    BUILTIN_WORD_SM_DIVIDE_REM,
    
    // Debug words

    BUILTIN_WORD_FINNISH,
    BUILTIN_WORD_SEE,
    BUILTIN_WORD_BREAKPOINT,
